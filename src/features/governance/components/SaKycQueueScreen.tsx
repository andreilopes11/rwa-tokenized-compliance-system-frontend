...
import { listAdminKycRequests } from "@/features/governance/api/client";
...
/** SA-S08 — KYC queue (SUPER_ADMIN) */
export function SaKycQueueScreen() {
          ...
          <tbody>
            {requests.map((request) => (
              <tr key={request.requestId}>
                ...
                <td>
                  <Link href={`/governance/kyc/${request.requestId}`}>Review</Link>
                </td>
              </tr>
            ))}
          </tbody>
