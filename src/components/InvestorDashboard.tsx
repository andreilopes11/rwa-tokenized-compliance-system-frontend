...
import { activeChain, explorerLink } from "@/lib/web3";
...
export function InvestorDashboard() {
  ...
  const commonCopy = dictionaries[locale].common;
  ...
  async function refreshStatus(address = walletAddress) {
    ...
    try {
      ...
      const [financialResponse, taxResponse, notificationResponse, tutorialResponse] = await Promise.all([
        ...
        fetchTaxSummary(address, locale),
        ...
        <div className="panel-grid">
          ...
          <section className="panel" aria-labelledby="portfolio-title">
            ...
            <div className="metric-grid">
              <div className="metric">
                <span>Total EUR</span>
                <strong>{formatCurrency(financialSummary?.totalValue ?? 0, "EUR", "pt-PT")}</strong>
              </div>
              <div className="metric">
                <span>Total USD</span>
              ...
              {chartData.length === 0 ? (
                ...
                <ResponsiveContainer height={220} width="100%">
                  <BarChart data={chartData}>
                    <XAxis dataKey="name" />
                    <YAxis />
                    <Tooltip formatter={(value) => formatCurrency(Number(value), "EUR", "pt-PT")} />
            ...
            {taxSummary && (
              <div className="secondary-panel">
                ...
                <span className="muted">
                  Estimated withholding {formatCurrency(taxSummary.estimatedWithholding, "EUR", "pt-PT")}
                </span>
